...
Elm.InputModel.make = function (_elm) {
   ...
   if (_elm.InputModel.values) return _elm.InputModel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var startSeed = $Random.initialSeed(9);
   var generatorFloat = A2($Random.$float,0,1);
   var Keys = F2(function (a,b) {    return {x: a,y: b};});
   var Controls = F2(function (a,b) {    return {tilePushDirection: a,newGameButtonPressed: b};});
   var None = {ctor: "None"};
   var Left = {ctor: "Left"};
   var Right = {ctor: "Right"};
   var Down = {ctor: "Down"};
   var Up = {ctor: "Up"};
   var convertDirection = function (keys) {
      return _U.eq(keys.x,0) && _U.eq(keys.y,1) ? Up : _U.eq(keys.x,0) && _U.eq(keys.y,-1) ? Down : _U.eq(keys.x,1) && _U.eq(keys.y,0) ? Right : _U.eq(keys.x,
      -1) && _U.eq(keys.y,0) ? Left : None;
   };
   var playerDirection = A2($Signal.merge,A2($Signal.map,convertDirection,$Keyboard.arrows),A2($Signal.map,convertDirection,$Keyboard.wasd));
   return _elm.InputModel.values = {_op: _op
                                   ,Up: Up
                                   ,Down: Down
                                   ,Right: Right
                                   ,Left: Left
...
Elm.Utils.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var randomGenerator = A2($Random.$float,0,1);
   var listRandom = F2(function (i,s) {
      var _p0 = i;
      if (_p0 === 0) {
            return _U.list([]);
         } else {
            var _p1 = A2($Random.generate,randomGenerator,s);
            var n = _p1._0;
            var newSeed = _p1._1;
            return A2($List._op["::"],n,A2(listRandom,i - 1,newSeed));
         }
   });
   var initSeed = $Random.initialSeed(42);
   var and = function (l) {    var _p2 = l;if (_p2.ctor === "[]") {    return true;} else {    return _p2._0 && and(_p2._1);}};
   var zipWith = F3(function (func,xs,ys) {
      var _p3 = {ctor: "_Tuple2",_0: xs,_1: ys};
      if (_p3._0.ctor === "::" && _p3._1.ctor === "::") {
            return A2($List._op["::"],A2(func,_p3._0._0,_p3._1._0),A3(zipWith,func,_p3._0._1,_p3._1._1));
         } else {
            return _U.list([]);
         }
   });
   var zip = F2(function (xs,ys) {
      ...
      if (_p4._0.ctor === "::" && _p4._1.ctor === "::") {
            return A2($List._op["::"],{ctor: "_Tuple2",_0: _p4._0._0,_1: _p4._1._0},A2(zip,_p4._0._1,_p4._1._1));
         } else {
            return _U.list([]);
         }
   });
   var ownListHead = function (ls) {
      var _p5 = ls;
      if (_p5.ctor === "::") {
            if (_p5._0.ctor === "Nothing") {
                  return $Maybe.Nothing;
               } else {
                  return $Maybe.Just(_p5._0._0);
               }
         } else {
            return $Maybe.Nothing;
         }
   };
   var transformMaybe = function (i) {    var _p6 = i;if (_p6.ctor === "Nothing") {    return _U.list([]);} else {    return _p6._0;}};
   var transpose = function (ls) {
      var _p7 = ls;
      if (_p7.ctor === "::" && _p7._0.ctor === "[]") {
            return _U.list([]);
         } else {
            return A2($List._op["::"],A2($List.map,ownListHead,ls),transpose(A2($List.map,function (_p8) {    return transformMaybe($List.tail(_p8));},ls)));
         }
   };
   _op["!"] = F2(function (l,n) {
      var _p9 = {ctor: "_Tuple2",_0: l,_1: n};
      if (_p9.ctor === "_Tuple2" && _p9._0.ctor === "::") {
            if (_p9._1 === 0) {
                  return $Maybe.Just(_p9._0._0);
               } else {
                  return A2(_op["!"],_p9._0._1,_p9._1 - 1);
               }
         } else {
            return $Maybe.Nothing;
         }
...
Elm.GameModel.make = function (_elm) {
   ...
   if (_elm.GameModel.values) return _elm.GameModel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var tileToInt = function (tile) {    var _p0 = tile;if (_p0.ctor === "Number") {    return _p0._0;} else {    return 0;}};
   var gridSize = 4;
   var tilesWithCoordinates = function (grid) {
      return $List.concat(A3($Utils.zipWith,
      F2(function (j,r) {    return A2($List.map,function (_p1) {    var _p2 = _p1;return {ctor: "_Tuple3",_0: _p2._0,_1: _p2._1,_2: j};},r);}),
      _U.range(0,gridSize - 1),
      A2($List.map,function (r) {    return A2($Utils.zip,r,_U.range(0,gridSize - 1));},grid)));
   };
   var GameState = F4(function (a,b,c,d) {    return {grid: a,score: b,initSeed: c,gameProgress: d};});
   var Won = {ctor: "Won"};
   var GameOver = {ctor: "GameOver"};
   var InProgress = {ctor: "InProgress"};
   var Empty = {ctor: "Empty"};
   var emptyGrid = A2($List.repeat,gridSize,A2($List.repeat,gridSize,Empty));
   var defaultGame = {grid: emptyGrid,score: 0,initSeed: $Utils.initSeed,gameProgress: InProgress};
   var readTile = F2(function (_p3,g) {
      var _p4 = _p3;
      var withMaybe = A2($Maybe.andThen,A2($Utils._op["!"],g,_p4._1),function (a) {    return A2($Utils._op["!"],a,_p4._0);});
      var _p5 = withMaybe;
      if (_p5.ctor === "Just") {
            return _p5._0;
         } else {
   ...
   var setTile = F3(function (_p6,grid,tile) {
      var _p7 = _p6;
      var _p12 = _p7._1;
      var _p11 = _p7._0;
      var row = A2($Utils._op["!"],grid,_p12);
      var newRow = function () {
         var _p8 = row;
         if (_p8.ctor === "Just") {
               var _p9 = _p8._0;
               return A2($Basics._op["++"],A2($List.take,_p11,_p9),A2($Basics._op["++"],_U.list([tile]),A2($List.drop,_p11 + 1,_p9)));
            } else {
               return _U.list([Empty]);
            }
      }();
      var _p10 = newRow;
      if (_p10.ctor === "::" && _p10._0.ctor === "Empty" && _p10._1.ctor === "[]") {
            return grid;
         } else {
            return A2($Basics._op["++"],A2($List.take,_p12,grid),A2($Basics._op["++"],_U.list([_p10]),A2($List.drop,_p12 + 1,grid)));
         }
   });
   var rotateGrid = function (grid) {
      var maybeGrid = A2($List.map,$List.map(function (x) {    return $Maybe.Just(x);}),grid);
      var transposedgrid = $Utils.transpose(maybeGrid);
      var reconvertedgrid = A2($List.map,
      $List.map(function (x) {    var _p13 = x;if (_p13.ctor === "Just") {    return _p13._0;} else {    return Empty;}}),
      transposedgrid);
      return A2($List.map,$List.reverse,reconvertedgrid);
   };
   var Number = function (a) {    return {ctor: "Number",_0: a};};
   var intToTile = function (i) {    var _p14 = i;if (_p14 === 0) {    return Empty;} else {    return Number(i);}};
   return _elm.GameModel.values = {_op: _op
                                  ,Number: Number
                                  ,Empty: Empty
...
Elm.Logic.make = function (_elm) {
   ...
   if (_elm.Logic.values) return _elm.Logic.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Utils = Elm.Utils.make(_elm);
   var _op = {};
   var emptyTiles = function (grid) {
      return A2($List.map,
      function (_p0) {
         var _p1 = _p0;
         return {ctor: "_Tuple2",_0: _p1._1,_1: _p1._2};
      },
      A2($List.filter,function (_p2) {    var _p3 = _p2;return _U.eq(_p3._0,$GameModel.Empty);},$GameModel.tilesWithCoordinates(grid)));
   };
   var newTileCoordinate = F2(function (random,grid) {
      var emptyTileIndices = emptyTiles(grid);
      var _p4 = emptyTileIndices;
      if (_p4.ctor === "[]") {
            return $Maybe.Nothing;
         } else {
            return A2($Utils._op["!"],emptyTileIndices,$Basics.floor($Basics.toFloat($List.length(emptyTileIndices)) * random));
         }
   });
   var probability2 = 0.9;
   var newTile = function (x) {    return _U.cmp(x,probability2) < 0 ? $GameModel.Number(2) : $GameModel.Number(4);};
   var placeRandomTile = function (gameState) {
      var _p5 = A2($Random.generate,$Utils.randomGenerator,gameState.initSeed);
      var rand1 = _p5._0;
      var seed1 = _p5._1;
      var _p6 = A2($Random.generate,$Utils.randomGenerator,seed1);
      var rand2 = _p6._0;
      var newSeed2 = _p6._1;
      var newT = newTile(rand2);
      var tileIndex = A2(newTileCoordinate,rand1,gameState.grid);
      var _p7 = tileIndex;
      if (_p7.ctor === "Nothing") {
            return _U.update(gameState,{initSeed: newSeed2});
         } else {
            return _U.update(gameState,{initSeed: newSeed2,grid: A3($GameModel.setTile,_p7._0,gameState.grid,newT)});
         }
   };
   var newGame = placeRandomTile(placeRandomTile($GameModel.defaultGame));
   var lose = function (gameState) {    return _U.update(gameState,{gameProgress: $GameModel.GameOver});};
   var win = function (gameState) {    return _U.update(gameState,{gameProgress: $GameModel.Won});};
   var gameWon = function (grid) {
      var gameSt = $List.length(A2($List.filter,function (t) {    return _U.eq(t,$GameModel.Number(2048));},$List.concat(grid)));
      return !_U.eq(0,gameSt);
   };
   var groupedByTwo = function (l) {
      ...
      if (_p8.ctor === "::") {
            if (_p8._1.ctor === "::") {
                  ...
                  var _p10 = _p8._1._1;
                  var _p9 = _p8._0;
                  return _U.eq(_p9,_p11) ? A2($List._op["::"],_U.list([_p9,_p11]),groupedByTwo(_p10)) : A2($List._op["::"],
                  _U.list([_p9]),
                  groupedByTwo(A2($List._op["::"],_p11,_p10)));
               } else {
   ...
   var slideRow = function (tilerow) {
      var count = function (lyy) {
         return function (_p12) {
            return $List.sum(A2($List.map,$GameModel.tileToInt,_p12));
         }($List.concat(A2($List.filter,function (x) {    return _U.cmp($List.length(x),1) > 0;},lyy)));
      };
      var slide = function (ly) {
         return A2($List.take,
         $GameModel.gridSize,
         A2($Basics._op["++"],
         A2($List.map,function (_p13) {    return $GameModel.intToTile($List.sum(A2($List.map,$GameModel.tileToInt,_p13)));},ly),
         A2($List.repeat,$GameModel.gridSize,$GameModel.Empty)));
      };
      var grouped = groupedByTwo(A2($List.filter,function (t) {    return !_U.eq(t,$GameModel.Empty);},tilerow));
      var lastelem = $List.head($List.reverse(grouped));
      var groupedWithoutempty = function () {
         var _p14 = lastelem;
         if (_p14.ctor === "Just") {
               if (_p14._0.ctor === "[]") {
                     return A2($Maybe.map,$List.reverse,$List.tail($List.reverse(grouped)));
                  } else {
                     return $Maybe.Just(grouped);
                  }
            } else {
               return $Maybe.Nothing;
            }
      }();
      var _p15 = groupedWithoutempty;
      if (_p15.ctor === "Just") {
            var _p16 = _p15._0;
            return {ctor: "_Tuple2",_0: slide(_p16),_1: count(_p16)};
         } else {
            return {ctor: "_Tuple2",_0: tilerow,_1: 0};
         }
   };
   var slideGrid = F2(function (dir,grid) {
      var rotatedGrid = function () {
         var _p17 = dir;
         switch (_p17.ctor)
         {case "Down": return $GameModel.rotateGrid(grid);
            case "Right": return function (_p18) {
                 return $GameModel.rotateGrid($GameModel.rotateGrid(_p18));
              }(grid);
            case "Up": return function (_p19) {
                 return $GameModel.rotateGrid($GameModel.rotateGrid($GameModel.rotateGrid(_p19)));
              }(grid);
            default: return grid;}
      }();
      var rowsWithScores = A2($List.map,slideRow,rotatedGrid);
      var slidRotatedGrid = A2($List.map,$Basics.fst,rowsWithScores);
      var slidGrid = function () {
         var _p20 = dir;
         switch (_p20.ctor)
         {case "Up": return $GameModel.rotateGrid(slidRotatedGrid);
            case "Right": return function (_p21) {
                 return $GameModel.rotateGrid($GameModel.rotateGrid(_p21));
              }(slidRotatedGrid);
            case "Down": return function (_p22) {
                 return $GameModel.rotateGrid($GameModel.rotateGrid($GameModel.rotateGrid(_p22)));
              }(slidRotatedGrid);
            default: return slidRotatedGrid;}
      }();
      var scoreGained = $List.sum(A2($List.map,$Basics.snd,rowsWithScores));
      return {ctor: "_Tuple2",_0: slidGrid,_1: scoreGained};
   });
   var slideGameState = F2(function (controls,gameState) {
      var newGridScore = A2(slideGrid,controls.tilePushDirection,gameState.grid);
      return _U.eq($Basics.fst(newGridScore),gameState.grid) ? gameState : _U.update(gameState,
      {grid: $Basics.fst(newGridScore),score: gameState.score + $Basics.snd(newGridScore)});
   });
   var gameLost = function (grid) {
      var right = $Basics.fst(A2(slideGrid,$InputModel.Right,grid));
      var left = $Basics.fst(A2(slideGrid,$InputModel.Left,grid));
      var down = $Basics.fst(A2(slideGrid,$InputModel.Down,grid));
      var up = $Basics.fst(A2(slideGrid,$InputModel.Up,grid));
      return $Utils.and(_U.list([!_U.eq(grid,$GameModel.emptyGrid),_U.eq(up,down),_U.eq(down,left),_U.eq(left,right),_U.eq(right,grid)]));
   };
   var stepGame = F2(function (controls,gameState) {
      if (controls.newGameButtonPressed) return newGame; else if (!_U.eq(gameState.gameProgress,$GameModel.InProgress)) return gameState;
         else if (gameWon(gameState.grid)) return win(gameState); else if (gameLost(gameState.grid)) return lose(gameState);
               else if (!_U.eq(controls.tilePushDirection,$InputModel.None)) {
                        var pushedState = A2(slideGameState,controls,gameState);
                        return _U.eq(pushedState,gameState) ? gameState : placeRandomTile(pushedState);
                     } else return gameState;
   });
   return _elm.Logic.values = {_op: _op
                              ...
                              ,newTileCoordinate: newTileCoordinate
                              ,placeRandomTile: placeRandomTile
                              ,newGame: newGame
                              ,stepGame: stepGame};
};
Elm.Rendering2048 = Elm.Rendering2048 || {};
Elm.Rendering2048.make = function (_elm) {
   "use strict";
   _elm.Rendering2048 = _elm.Rendering2048 || {};
   if (_elm.Rendering2048.values) return _elm.Rendering2048.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var tileTextColor = function (tile) {
      var _p1 = tile;
      if (_p1.ctor === "Number") {
            return _U.cmp(_p1._0,8) > -1 ? A3($Color.rgb,249,246,242) : A3($Color.rgb,119,110,101);
         } else {
            return $Color.black;
         }
   };
   var tileTextStyle = function (tile) {
      return {typeface: _U.list(["Helvetica Neue","Arial","sans-serif"])
   ...
   var tileColor = function (tile) {
      ...
      _v2_11: do {
         if (_p2.ctor === "Number") {
               switch (_p2._0)
               {case 2: return A3($Color.rgb,238,228,218);
                  case 4: return A3($Color.rgb,237,224,200);
                  case 8: return A3($Color.rgb,242,177,121);
                  case 16: return A3($Color.rgb,245,149,99);
                  case 32: return A3($Color.rgb,246,124,95);
                  case 64: return A3($Color.rgb,246,94,59);
                  case 128: return A3($Color.rgb,237,207,114);
                  case 256: return A3($Color.rgb,237,204,97);
                  case 512: return A3($Color.rgb,237,200,80);
                  case 1024: return A3($Color.rgb,237,197,63);
                  case 2048: return A3($Color.rgb,237,194,46);
                  default: break _v2_11;}
            } else {
               break _v2_11;
            }
      } while (false);
      return A4($Color.rgba,238,228,218,0.35);
   };
   var wonMessage = "You won!";
   var gameOverMessage = "Game over!";
   var wonOverlayColor = A4($Color.rgba,237,194,46,0.5);
   var gameOverOverlayColor = A4($Color.rgba,238,228,218,0.73);
   ...
   var displayOverlay = F3(function (s,c,st) {
      return A3($Graphics$Collage.collage,
      $Basics.round(gridWidth),
      $Basics.round(gridWidth),
      _U.list([A2($Graphics$Collage.filled,c,$Graphics$Collage.square(gridWidth))
              ,$Graphics$Collage.toForm($Graphics$Element.centered(A2($Text.style,s,$Text.fromString(st))))]));
   });
   var displayGameOverOverlay = A3(displayOverlay,gameOverOverlayStyle,gameOverOverlayColor,gameOverMessage);
   var displayWonOverlay = A3(displayOverlay,wonOverlayStyle,wonOverlayColor,wonMessage);
   var applyOverlay = F2(function (overlay,grid) {
      return A3($Graphics$Collage.collage,
      $Basics.round(gridWidth),
      $Basics.round(gridWidth),
      _U.list([$Graphics$Collage.toForm(grid),$Graphics$Collage.toForm(overlay)]));
   });
   var displayTile = function (tile) {
      var tileBackGround = A2($Graphics$Collage.filled,tileColor(tile),$Graphics$Collage.square(tileSize));
      var _p3 = tile;
      if (_p3.ctor === "Number") {
            return A3($Graphics$Collage.collage,
            $Basics.round(tileSize),
            $Basics.round(tileSize),
            _U.list([tileBackGround
                    ,$Graphics$Collage.toForm($Graphics$Element.centered(A2($Text.style,tileTextStyle(tile),$Text.fromString($Basics.toString(_p3._0)))))]));
         } else {
            return A3($Graphics$Collage.collage,$Basics.round(tileSize),$Basics.round(tileSize),_U.list([tileBackGround]));
         }
   };
   var displayiTileAtCoordinates = function (_p4) {
      var _p5 = _p4;
      var y = -1 * (tileSize + tileMargin) * ($Basics.toFloat(_p5._2) - ($Basics.toFloat($GameModel.gridSize) - 1) / 2);
      var x = (tileSize + tileMargin) * ($Basics.toFloat(_p5._1) - ($Basics.toFloat($GameModel.gridSize) - 1) / 2);
      var position = {ctor: "_Tuple2",_0: x,_1: y};
      return A2($Graphics$Collage.move,position,$Graphics$Collage.toForm(displayTile(_p5._0)));
   };
   var displayGrid = function (grid) {
      var tiles = A2($List.map,displayiTileAtCoordinates,$GameModel.tilesWithCoordinates(grid));
      var gridBox = A2($Graphics$Collage.filled,A3($Color.rgb,187,173,160),$Graphics$Collage.square(gridWidth));
      return A3($Graphics$Collage.collage,$Basics.round(gridWidth),$Basics.round(gridWidth),A2($Basics._op["++"],_U.list([gridBox]),tiles));
   };
   var displayGameState = function (state) {
      var currentGrid = displayGrid(state.grid);
      var _p6 = state.gameProgress;
      switch (_p6.ctor)
      {case "GameOver": return A2(applyOverlay,displayGameOverOverlay,currentGrid);
         case "Won": return A2(applyOverlay,displayWonOverlay,currentGrid);
         default: return displayGrid(state.grid);}
   };
   return _elm.Rendering2048.values = {_op: _op
                                      ,tileSize: tileSize
                                      ...
                                      ,displayiTileAtCoordinates: displayiTileAtCoordinates
...
Elm.Elm2048.make = function (_elm) {
   ...
   if (_elm.Elm2048.values) return _elm.Elm2048.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $GameModel = Elm.GameModel.make(_elm),
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Rendering2048 = Elm.Rendering2048.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var setControls = F2(function (d,b) {    return {tilePushDirection: d,newGameButtonPressed: b};});
   ...
   var controls = A3($Signal.map2,setControls,$InputModel.playerDirection,newGameButton);
   var gameState = A3($Signal.foldp,$Logic.stepGame,$GameModel.defaultGame,controls);
   var score = Elm.Native.Port.make(_elm).outboundSignal("score",function (v) {    return v;},A2($Signal.map,function (x) {    return x.score;},gameState));
   var main = A2($Signal.map,$Rendering2048.displayGameState,gameState);
   return _elm.Elm2048.values = {_op: _op,main: main,controls: controls,gameState: gameState,setControls: setControls};
};
